...
namespace CorsExample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // CorsAuthorizationFilterFactory doesn't exist anymore
            // services.AddMvc(options => options.Filters.Add(new CorsAuthorizationFilterFactory("AwesomePolicy1")));
            services.AddMvc(options => options.EnableEndpointRouting = false); // code added to build and run the project
        }
